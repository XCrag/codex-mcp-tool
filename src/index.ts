...
function startProgressUpdates(
  ...
  const progressMessages = [
    `🧠 ${operationName} - Codex is working on your request...`,
    `📊 ${operationName} - Reading files and generating changes...`,
    `✨ ${operationName} - Creating structured response for your review...`,
    `⏱️ ${operationName} - Large task in progress (this is normal for big requests)...`,
