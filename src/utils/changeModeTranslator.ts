...
Codex has analyzed your codebase and generated edits across ${chunkInfo.total} chunks.
...
`
    : `[CHANGEMODE OUTPUT - Codex has analyzed the files and provided these edits]
